...
class _$ApiResultTearOff {
  ...
  Failure<T> apiFailure<T>({required String error}) {
    return Failure<T>(
      error: error,
    );
  }
...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String error) apiFailure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T data)? success,
    TResult Function(String error)? apiFailure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$Failure<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.apiFailure(error: $error)';
  }
